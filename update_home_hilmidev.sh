...
BACKUP_DIR="storage/app/home-premium-backup-$STAMP"

mkdir -p "$BACKUP_DIR/app/Http/Controllers"
mkdir -p "$BACKUP_DIR/resources/views"

[ -f app/Http/Controllers/HomeController.php ] && \
    cp app/Http/Controllers/HomeController.php "$BACKUP_DIR/app/Http/Controllers/HomeController.php"

[ -f resources/views/home.blade.php ] && \
    cp resources/views/home.blade.php "$BACKUP_DIR/resources/views/home.blade.php"

cat > app/Http/Controllers/HomeController.php <<'PHP'
<?php
...
echo ""
echo "============================================================"
echo "HOME HILMIDEV BERHASIL DIPERBARUI"
echo "============================================================"
echo "Backup: $BACKUP_DIR"
echo "Tes: php artisan serve"
