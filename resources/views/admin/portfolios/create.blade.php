            ...
            <div class="relative flex items-center justify-between gap-4">
                <div>
                    ...
                    <p class="text-blue-50 mt-3">
                        Tambahkan showcase project premium HilmiDev.
                    </p>
                </div>
                    ...
                    <div class="space-y-5">
                        <div>
                            ...
                            <input type="text"
                                   ...
                                   placeholder="Contoh: Sistem POS Premium">
                        ...
                        <div>
                            ...
                            <textarea name="short_description"
                                      rows="3"
                                      class="w-full rounded-2xl border-blue-100 focus:border-blue-500 focus:ring-blue-500"
                                      placeholder="Ringkasan project untuk card portfolio">{{ old('short_description') }}</textarea>
                        ...
                        <div>
                            ...
                            <textarea name="description"
                                      rows="7"
                                      class="w-full rounded-2xl border-blue-100 focus:border-blue-500 focus:ring-blue-500"
                                      placeholder="Jelaskan masalah, solusi, fitur, dan hasil project">{{ old('description') }}</textarea>
                        ...
                        <div>
                            ...
                            <textarea name="tech_stack"
                                      rows="5"
                                      class="w-full rounded-2xl border-blue-100 focus:border-blue-500 focus:ring-blue-500"
                                      placeholder="Tulis 1 teknologi per baris">{{ old('tech_stack') }}</textarea>
                ...
                <div class="bg-white border border-blue-100 rounded-[2rem] p-6 shadow-2xl shadow-blue-500/10 lg:sticky lg:top-28">
                    <div class="flex items-center gap-3 mb-6">
                        ...
                        <div>
                            ...
                            <p class="text-sm text-slate-500">Upload thumbnail dan galeri.</p>
                        </div>
                    </div>
                    ...
                    <div class="space-y-5">
                        ...
                        <div>
                            <label class="block text-sm font-bold text-slate-700 mb-2">Gallery</label>
                            <input type="file"
                                   name="gallery[]"
                                   multiple
                                   class="w-full rounded-2xl border border-blue-100 bg-blue-50/50 p-3 text-sm">
                            <p class="text-xs text-slate-500 mt-2">Bisa pilih lebih dari 1 gambar.</p>
