    ...
    <div class="max-w-4xl mx-auto px-4 py-10">
        <div class="relative overflow-hidden rounded-[2rem] bg-gradient-to-br from-blue-600 via-cyan-500 to-blue-400 p-8 text-white shadow-2xl shadow-blue-500/20 mb-8">
            ...
            <div class="relative">
                ...
                <h1 class="text-3xl md:text-5xl font-black">Edit Kategori</h1>
                <p class="text-blue-50 mt-3">Perbarui data kategori source code.</p>
            </div>
        </div>
        ...
        <form action="{{ route('admin.categories.update', $category) }}"
            ...
            <div>
                ...
                <textarea name="description"
                          rows="5"
                          class="w-full rounded-2xl border-blue-100 focus:border-blue-500 focus:ring-blue-500">{{ old('description', $category->description) }}</textarea>
