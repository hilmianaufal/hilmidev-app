            ...
            <div class="relative flex items-center justify-between gap-4">
                <div>
                    ...
                    <p class="text-blue-50 mt-3">
                        Perbarui layanan premium HilmiDev.
                    </p>
                </div>
                    ...
                    <div class="space-y-5">
                        ...
                        <div>
                            ...
                            <textarea name="short_description"
                                      rows="3"
                                      class="w-full rounded-2xl border-blue-100 focus:border-blue-500 focus:ring-blue-500"
                                      placeholder="Deskripsi singkat untuk card jasa">{{ old('short_description', $service->short_description) }}</textarea>
                        ...
                        <div>
                            ...
                            <textarea name="description"
                                      rows="7"
                                      class="w-full rounded-2xl border-blue-100 focus:border-blue-500 focus:ring-blue-500"
                                      placeholder="Jelaskan layanan, proses pengerjaan, benefit, dan estimasi">{{ old('description', $service->description) }}</textarea>
                        ...
                        <div>
                            ...
                            <textarea name="features"
                                      rows="6"
                                      class="w-full rounded-2xl border-blue-100 focus:border-blue-500 focus:ring-blue-500"
                                      placeholder="Tulis 1 fitur per baris">{{ old('features', $service->features ? implode("\n", $service->features) : '') }}</textarea>
                        ...
                        <div>
                            ...
                            @if ($service->thumbnail)
                                <img src="{{ asset('storage/' . $service->thumbnail) }}"
                                     ...
                                     alt="{{ $service->title }}">
                            @else
                                <div class="w-full aspect-video rounded-2xl bg-blue-50 border border-blue-100 flex items-center justify-center text-4xl mb-3">
                                    {{ $service->icon ?? '💼' }}
                                </div>
                            @endif
