            ...
            <div class="relative flex items-center justify-between gap-4">
                <div>
                    ...
                    <p class="text-blue-50 mt-3">
                        Upload source code premium ke marketplace HilmiDev.
                    </p>
                </div>
                ...
                <div class="bg-white border border-blue-100 rounded-[2rem] p-6 shadow-xl shadow-blue-500/5">
                    ...
                    <div class="space-y-5">
                        <div>
                            ...
                            <select name="category_id" class="w-full rounded-2xl border-blue-100 focus:border-blue-500 focus:ring-blue-500">
                        ...
                        <div>
                            ...
                            <textarea name="short_description" rows="3"
                                      class="w-full rounded-2xl border-blue-100 focus:border-blue-500 focus:ring-blue-500"
                                      placeholder="Deskripsi singkat untuk card produk">{{ old('short_description') }}</textarea>
                        ...
                        <div>
                            ...
                            <textarea name="description" rows="7"
                                      class="w-full rounded-2xl border-blue-100 focus:border-blue-500 focus:ring-blue-500"
                                      placeholder="Jelaskan fitur, keunggulan, teknologi, dan cara penggunaan">{{ old('description') }}</textarea>
                        ...
                        <div>
                            ...
                            <p class="text-xs text-slate-500 mt-2">Contoh: Login Admin, Manajemen Produk, Laporan Penjualan</p>
            ...
            <aside class="space-y-6">
                <div class="bg-white border border-blue-100 rounded-[2rem] p-6 shadow-2xl shadow-blue-500/10 lg:sticky lg:top-28">
                    <div class="flex items-center gap-3 mb-6">
                        ...
                        <div>
                            <h2 class="font-black text-slate-900">Harga</h2>
                            <p class="text-sm text-slate-500">Atur harga produk.</p>
                        </div>
                    </div>
                    ...
                    <div class="space-y-5">
                        ...
                        <div>
                            <label class="block text-sm font-bold text-slate-700 mb-2">File Source Code</label>
                            <input type="file" name="file_path"
                                   class="w-full rounded-2xl border border-blue-100 bg-blue-50/50 p-3 text-sm">
                            <p class="text-xs text-slate-500 mt-2">Upload ZIP/RAR source code.</p>
