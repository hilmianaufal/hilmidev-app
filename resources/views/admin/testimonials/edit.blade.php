            ...
            <div class="relative flex items-center justify-between gap-4">
                <div>
                    ...
                    <p class="text-blue-50 mt-3">
                        Perbarui review client HilmiDev.
                    </p>
                </div>
                    ...
                    <div class="space-y-5">
                        ...
                        <div>
                            ...
                            <textarea name="review"
                                      rows="7"
                                      class="w-full rounded-2xl border-blue-100 focus:border-blue-500 focus:ring-blue-500">{{ old('review', $testimonial->review) }}</textarea>
                        ...
                        <div>
                            ...
                            @if ($testimonial->photo)
                                <img src="{{ asset('storage/' . $testimonial->photo) }}"
                                     class="w-28 h-28 rounded-3xl object-cover border border-blue-100 shadow-lg shadow-blue-500/10 mb-3"
                                     alt="{{ $testimonial->name }}">
                            @else
                                <div class="w-28 h-28 rounded-3xl bg-blue-50 border border-blue-100 flex items-center justify-center text-blue-500 mb-3">
