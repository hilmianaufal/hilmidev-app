    ...
    <div class="max-w-7xl mx-auto px-4 py-10">
        <div class="relative overflow-hidden rounded-[2rem] bg-gradient-to-br from-blue-600 via-cyan-500 to-blue-400 p-8 text-white shadow-2xl shadow-blue-500/20 mb-8">
            ...
            <div class="relative">
                ...
                <h1 class="text-3xl md:text-5xl font-black">Kelola Order</h1>
                <p class="text-blue-50 mt-3">Pantau invoice, pembayaran, dan status pembelian source code.</p>
            </div>
        </div>
                    ...
                    <tbody class="divide-y divide-blue-50">
                        @forelse ($orders as $order)
                            <tr class="hover:bg-blue-50/40 transition">
                                <td class="px-5 py-5">
                                    <p class="font-black text-slate-900">{{ $order->invoice_number }}</p>
