            ...
            <div class="relative flex items-center justify-between gap-4">
                <div>
                    ...
                    <p class="text-blue-50 mt-3">
                        Buat artikel blog SEO HilmiDev dengan editor TinyMCE.
                    </p>
                </div>
        ...
        <form action="{{ route('admin.posts.store') }}"
                    ...
                    <div class="space-y-5">
                        <div>
                            ...
                            <input type="text"
                                   ...
                                   placeholder="Contoh: Jasa Website Laravel Profesional">
                        ...
                        <div>
                            ...
                            <textarea name="excerpt"
                                      rows="3"
                                      class="w-full rounded-2xl border-blue-100 focus:border-blue-500 focus:ring-blue-500"
                                      placeholder="Ringkasan pendek artikel untuk halaman blog dan SEO">{{ old('excerpt') }}</textarea>
                        ...
                        <div>
                            ...
                            <textarea id="content"
                                      name="content"
                                      rows="16"
                                      class="w-full rounded-2xl border-blue-100 focus:border-blue-500 focus:ring-blue-500">{{ old('content') }}</textarea>
                    ...
                    <div class="space-y-5">
                        <div>
                            ...
                            <input type="text"
                                   ...
                                   class="w-full rounded-2xl border-blue-100 focus:border-blue-500 focus:ring-blue-500"
                                   placeholder="Jasa Website Laravel Profesional | HilmiDev">
                        ...
                        <div>
                            ...
                            <textarea name="meta_description"
                                      rows="4"
                                      class="w-full rounded-2xl border-blue-100 focus:border-blue-500 focus:ring-blue-500"
                                      placeholder="Deskripsi SEO untuk hasil pencarian Google">{{ old('meta_description') }}</textarea>
            ...
            <aside class="space-y-6">
                <div class="bg-white border border-blue-100 rounded-[2rem] p-6 shadow-2xl shadow-blue-500/10 lg:sticky lg:top-28">
                    ...
                    <div class="space-y-5">
                        ...
                        <label class="flex items-center justify-between gap-3 bg-blue-50 border border-blue-100 rounded-2xl p-4">
                            <span class="font-bold text-slate-700">Publish Sekarang</span>
                            <input type="checkbox"
                                   name="is_published"
                                   value="1"
                ...
                <div class="bg-slate-950 text-white rounded-[2rem] p-6 shadow-2xl shadow-blue-500/20">
                    <div class="w-12 h-12 rounded-2xl bg-blue-600 flex items-center justify-center mb-5">
                        <i data-lucide="lightbulb" class="w-6 h-6"></i>
                    </div>

                    <h3 class="font-black text-xl mb-3">Tips SEO</h3>

                    <ul class="space-y-3 text-sm text-slate-300">
                        <li>• Pakai keyword di judul.</li>
                        <li>• Buat excerpt singkat dan jelas.</li>
                        <li>• Gunakan heading H2/H3 di artikel.</li>
                        <li>• Meta description ideal 140-160 karakter.</li>
                    </ul>
                </div>
            </aside>
        </form>
